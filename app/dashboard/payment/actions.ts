...
export async function getUserPayoutMethods(userId: string) {
  ...
  try {
    ...
    console.error("Error in getUserPayoutMethods:", error);
    return { error: "An unexpected error occurred" };
  }
}

export async function setDefaultPayoutMethod(payoutMethodId: string, userId: string) {
  const supabase = createServerSupabase();
...
export async function deletePayoutMethod(payoutMethodId: string, userId: string) {
  const supabase = createServerSupabase();
