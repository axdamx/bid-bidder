  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4">
      <div className="mx-auto max-w-6xl">
        {/* Header Skeleton */}
        <div className="mb-8 h-8 w-32 animate-pulse rounded-md bg-gray-200" />
        ...
        <div className="mb-8 flex justify-center space-x-8">
          {[1, 2, 3].map((step) => (
            <div key={step} className="flex items-center">
              ...
              <div className="ml-2 h-4 w-16 animate-pulse rounded-md bg-gray-200" />
            ...
            <div className="mt-8 grid grid-cols-3 gap-4 text-center">
              {[1, 2, 3].map((item) => (
                <div key={item} className="space-y-2">
                  <div className="mx-auto h-6 w-6 animate-pulse rounded-full bg-gray-200" />
                  <div className="h-4 w-16 mx-auto animate-pulse rounded-md bg-gray-200" />
                  <div className="h-4 w-24 mx-auto animate-pulse rounded-md bg-gray-200" />
                </div>
              ))}
            </div>
          </div>
